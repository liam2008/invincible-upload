        ...
        var purchasePlanConfig = [
            {
                ...
                handlerTypes: [                                 // 流程：类目主管 -> 运营经理 -> 供应链主管
                    ["director"],
                    ["manager"],
                    ["purchaseDirector"]
                ],
                statuses: [200, 210, 300]                       // 流程的状态： 200: 类目主管审核, 210: 运营经理审核, 300: 供应链主管审核
            },
            {
                ...
                statuses: [200, 210, 220, 300, 310]             // 流程的状态： 200: 类目主管审核, 210: 运营经理审核, 220: 运营总监审核, 300: 供应链主管审核, 310: 供应链总监
            },
            {
                ...
                statuses: [200, 210, 220, 230, 300, 310]        // 流程的状态： 200: 类目主管审核, 210: 运营经理审核, 220: 运营总监审核, 230: CEO审核, 300: 供应链主管审核, 310: 供应链总监
            }
        ];
